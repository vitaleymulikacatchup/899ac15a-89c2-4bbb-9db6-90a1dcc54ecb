...
export const metadata: Metadata = {
  title: "ShopApp - iPhone Shopping Made Simple",
  description: "Compare prices, read reviews, and buy iPhones with confidence. Download our app for exclusive deals and seamless mobile shopping experience.",
  keywords: "iPhone shopping, mobile app, price comparison, smartphone deals, iPhone reviews",
  openGraph: {
    title: "ShopApp - iPhone Shopping Made Simple",
    description: "Compare prices, read reviews, and buy iPhones with confidence. Download our app for exclusive deals.",
    siteName: "ShopApp",
    images: [{
      url: "https://images.pexels.com/photos/16675636/pexels-photo-16675636.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "ShopApp iPhone shopping interface"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "ShopApp - iPhone Shopping Made Simple",
    description: "Compare prices, read reviews, and buy iPhones with confidence.",
    images: ["https://images.pexels.com/photos/16675636/pexels-photo-16675636.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
